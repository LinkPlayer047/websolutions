...
const Hero = () => {
  return (
    <section className="relative w-full h-screen overflow-hidden flex items-center justify-center">
      {/* Background Video */}
      <video
        src="/hero.mp4" // ← apni downloaded video yaha daalo
        autoPlay
        loop
        muted
        playsInline
      ...
      <div className="relative z-20 w-full max-w-5xl px-6 flex flex-col items-center text-center text-white">
        ...
        {/* CARD WITH HALF OUT BUTTON */}

        {/* HALF OUTSIDE BUTTON */}
        <Link
              href="/"
              className="group mt-5 absolute -bottom-40 flex items-center justify-center gap-2 bg-[#c5003e] text-white py-2 px-5 rounded-full font-semibold transition-all duration-300 hover:-translate-y-1 hover:bg-[#173b63]"
            >
              Let's Talk
